                    ...
                    <div className="course_des_textarea mt-30 lbel25">
                      ...
                      <div className="course_des_bg">
                        <ul className="course_des_ttle">
                          <li>
                            <a href="#">
                              <i className="uil uil-bold" />
                            </a>
                          </li>
                          <li>
                            <a href="#">
                              <i className="uil uil-italic" />
                            </a>
                          </li>
                          <li>
                            <a href="#">
                          ...
                          <li>
                            <a href="#">
                              <i className="uil uil-left-to-right-text-direction" />
                            </a>
                          </li>
                          <li>
                            <a href="#">
                              <i className="uil uil-right-to-left-text-direction" />
                            </a>
                          </li>
                          <li>
                            <a href="#">
                          ...
                          <li>
                            <a href="#">
                              <i className="uil uil-text-size" />
                            </a>
                          </li>
                          <li>
                            <a href="#">
                              <i className="uil uil-text" />
                            </a>
                          </li>
                        </ul>
